...
For this {deliverable} you can select either serving type. Then follow these instructions:

* :deploying-a-model-single-model-server.adoc[Deploying a model on a single-model server]	
