...
+
image::pipelines/dsp-pipline-import-upload.png[Import pipeline, 500]

.. Click *Import pipeline* to import and save the pipeline.
+
The pipeline shows in graphic view.
+
image::pipelines/python-pipeline-graph.png[Graphic view of pipeline, 800]
...
+
image::pipelines/pipeline-create-run-form.png[Create Pipeline Run form, 500]
