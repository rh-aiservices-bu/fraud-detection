...
+
image:images/pipelines/wb-download.png[Download Pipeline YAML]
...
+
image:images/pipelines/dsp-pipeline-import.png[]
...
+
image:images/pipelines/dsp-pipline-import-upload.png[]
...
+
image:images/pipelines/pipeline-create-run-form.png[Create Pipeline Run form]

. Click *Create* to create the run.
+
A new run starts immediately and opens the run details page.
+
image:images/pipelines/pipeline-run-in-progress.png[]
