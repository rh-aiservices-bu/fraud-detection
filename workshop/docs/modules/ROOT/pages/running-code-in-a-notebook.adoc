...
image::workbenches/cell.png[Jupyter Cell, 600]

This is a cell with some code:

image::workbenches/cell_code.png[Jupyter Cell Code, 600]
...
image::workbenches/cell_run.png[Jupyter run cell, 600]
...
+
image::workbenches/jupyter-notebook-0.png[Notebook 0, 600]
