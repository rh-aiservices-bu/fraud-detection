...
NOTE: If you're already at ease with Jupyter, you can xref:training-a-data-model[skip to the next section].
...
xref:training-a-data-model[Running code in a notebook]
