...
image:images/workbenches/cell.png[Jupyter Cell]

This is a cell with some code:

image:images/workbenches/cell_code.png[Jupyter Cell Code]
...
+
image:images/workbenches/run_button.png[Jupyter Run]
...
image:images/workbenches/cell_run.png[Jupyter run cell]
...
+
image:images/workbenches/jupyter-notebook-0.png[Notebook 0]
...
+
image:images/workbenches/new_notebook.png[alt text]
...
xref:training-a-data-model.adoc[Running code in a notebook]
