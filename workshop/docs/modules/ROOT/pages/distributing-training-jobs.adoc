...
xref:distributing-jobs-with-ray.adoc[Distributing training jobs with Ray].

* The Training Operator, as described in 
xref:distributing-jobs-with-kfto.adoc[Distributing training jobs with the Training Operator].
