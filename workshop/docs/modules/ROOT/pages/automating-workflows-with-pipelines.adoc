...
+
image:images/pipelines/wb-pipeline-launcher.png[Pipeline buttons]

. Click *Pipeline Editor*.
+
image:images/pipelines/wb-pipeline-editor-button.png[Pipeline Editor button, 100]
+
...
+
image:images/pipelines/wb-pipeline-panel-button-loc.png[Open Panel]

.. Select the *Pipeline Properties* tab.
+
image:images/pipelines/wb-pipeline-properties-tab.png[Pipeline Properties Tab]
...
+
image:images/pipelines/wb-pipeline-runtime-image.png[Pipeline Runtime Image0, 400]
...
+
image:images/pipelines/wb-pipeline-drag-drop.png[ Drag and Drop Notebooks]

. Click the output port of `1_experiment_train.ipynb` and drag a connecting line to the input port of `2_save_model.ipynb`.
+
image:images/pipelines/wb-pipeline-connect-nodes.png[Connect Nodes, 400]
...
+
image:images/pipelines/wb-pipeline-node-1.png[Select Node 1, 200]

. In the Properties panel, click the *Node Properties* tab.

. Scroll down to the *File Dependencies* section and then click *Add*.
+
image:images/pipelines/wb-pipeline-node-1-file-dep.png[Add File Dependency, 400]
...
+
image:images/pipelines/wb-pipeline-node-1-file-dep-form.png[Set File Dependency Value, 300]
...
+
image:images/pipelines/wb-pipeline-node-1-file-output-form.png[Set file dependency value, 400]
...
image:images/pipelines/dsp-dc-secret-name.png[My Storage Secret Name, 400]
====
...
+
image:images/pipelines/wb-pipeline-node-remove-env-var.png[Remove Env Var]

. Add the S3 bucket and keys by using the Kubernetes secret.

.. Under *Kubernetes Secrets*, click *Add*.
+
image:images/pipelines/wb-pipeline-add-kube-secret.png[Add Kube Secret]
...
+
image:images/pipelines/wb-pipeline-kube-secret-form.png[Secret Form, 400]
...
+
image:images/pipelines/wb-pipeline-run-button.png[Pipeline Run Button]
