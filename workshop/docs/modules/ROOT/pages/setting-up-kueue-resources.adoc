...
NOTE: If you are using the Red Hat Developer Sandbox, or if you do not intend to complete the Distributing training jobs with the Training operator section of this {deliverable}, skip this section and continue to the next section, xref:creating-a-workbench.adoc[Creating a workbench and selecting a workbench image].
