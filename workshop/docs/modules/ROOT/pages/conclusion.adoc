...
Congratulations! You have successfully completed the fraud detection tutorial! In this {deliverable}, you learned how to incorporate data science, artificial intelligence, and machine learning into an OpenShift development workflow.
