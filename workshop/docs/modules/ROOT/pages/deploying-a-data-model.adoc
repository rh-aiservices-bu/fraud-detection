...
. Click *Add server*.
+
image:images/model-serving/ds-project-model-list-add.png[Add Server]
...
+
image:images/model-serving/create-model-server-form.png[Add Server Form]

. Click *Add*.

. In the *Models and model servers* list, next to the new model server, click *Deploy model*.
+
image:images/model-serving/ds-project-workbench-list-deploy.png[Deploy model button]
...
+
image:images/model-serving/deploy-model-form.png[Deploy model form]

. Wait for the model to deploy and for the *Status* to show a green checkmark.
+
image:images/model-serving/ds-project-model-list-status.png[Model status]
