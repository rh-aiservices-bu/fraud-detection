...
image:images/projects/dashboard-enabled.png[Dashboard Enabled]
...
+
image:images/projects/dashboard-click-projects.png[Data Science Projects List]
+
...
+
image:images/projects/ds-project-new-form.png[New data science project form]

. You can now see its initial state. There are five types of project components:
+
image:images/projects/ds-project-new.png[New data science project]
