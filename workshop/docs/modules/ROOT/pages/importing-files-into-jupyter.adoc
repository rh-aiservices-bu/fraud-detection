...
*You created a workbench, as described in xref:creating-a-workbench[Creating a workbench and selecting a Notebook image].
...
xref:running-code-in-a-notebook[Running code in a notebook]

or

xref:training-a-data-model[Training a data model]
