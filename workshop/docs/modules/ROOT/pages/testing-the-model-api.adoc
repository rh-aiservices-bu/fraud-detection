...
+
image:images/model-serving/ds-project-model-list-name.png[Model name]
+
image:images/model-serving/ds-project-model-list-url.png[Model URL]
...
image:images/model-serving/wb-notebook-requests.png[Request Notebooks]
