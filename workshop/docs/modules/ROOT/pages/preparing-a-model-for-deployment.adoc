...
* You created the connection `My Storage`.
+
image::model-serving/create-workbench-form-data-connection.png[Workbench connection form, 600]

* You added the `My Storage` connection to your workbench.
+
