...
* If you intend to complete the pipelines section of this {deliverable}, you configured a pipeline server as described in xref:enabling-ai-pipelines.adoc[Enabling AI pipelines].

* If you intend to complete the _Distributing training jobs with the Training Operator_ section of this {deliverable}, you completed the procedure described in xref:setting-up-kueue-resources.adoc[Setting up Kueue resources].
//Note that the _Distributing training jobs with the Training Operator_ section of this {deliverable} is not supported in the {org-name} Developer Sandbox.

.Procedure

. Navigate to the project detail page for the project that you created in xref:setting-up-your-project.adoc[Setting up your project].
...
image::workbenches/ds-project-workbench-list.png[Workbench list, 800]
