...
+
image:images/workbenches/ds-project-create-workbench.png[Create workbench button]

. Fill out the name and description.
+
image:images/workbenches/create-workbench-form-name-desc.png[Workbench name and description, 600]
+
...
+
image:images/workbenches/create-workbench-form-image.png[Workbench image, 600]

. Choose a small deployment and no GPUs. This {deliverable} does not require any GPUs.
+
image:images/workbenches/create-workbench-form-size.png[Workbench size,600]

. Leave the default environment variables and storage options.
+
image:images/workbenches/create-workbench-form-env-storage.png[Workbench storage, 600]
...
+
image:images/workbenches/create-workbench-form-data-connection.png[Data connection, 600]

. Click the *Create workbench* button.
+
image:images/workbenches/create-workbench-form-button.png[Create workbench button]

.Verification

In the project details page, the status of the workbench changes from `Starting` to `Running`.

image:images/workbenches/ds-project-workbench-list.png[Workbench list]

NOTE: If you made a mistake, you can edit ithe workbench to make changes.

image:images/workbenches/ds-project-workbench-list-edit.png[Workbench list edit]
