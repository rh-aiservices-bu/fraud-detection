...
+
{org-name} provides several supported workbench images. In the *Workbench image* section, you can choose one of the default images or a custom image that an administrator has set up for you. The *Tensorflow* image has most of the libraries that you need for this {deliverable}.
