...
* You created a `My Storage` data connection as described in xref:storing-data-with-data-connections[Storing data with data connections].

* You configured a pipeline server as described in xref:enabling-data-science-pipelines[Enabling data science pipelines].


.Procedure

. Navigate to the project detail page for the data science project that you created in xref:setting-up-your-data-science-project[Setting up your data science project].
...
xref:importing-files-into-jupyter[Importing the {deliverable} files into the Jupyter environment]
