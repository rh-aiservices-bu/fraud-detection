...
+
image:images/projects/ds-project-add-dc.png[Add data connection]
...
+
image:images/projects/ds-project-my-storage-form.png[Add my storage form]
...
+
image:images/projects/ds-project-pipeline-artifacts-form.png[Add pipeline artifacts form]
...
image:images/projects/ds-project-dc-list.png[List of project data connections]
