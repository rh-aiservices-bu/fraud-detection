...
image:images/projects/ds-project-list-resource-hover.png[Project list resource name]
...
+
image:images/projects/ds-project-ocp-link.png[OpenShift Console Link]

. In the OpenShift console, click *+* in the top navigation bar.
+
image:images/projects/ocp-console-add-icon.png[Add resources Icon]

. Select your project from the list of projects.
+
image:images/projects/ocp-console-select-project.png[Select a project]

. Verify that you selected the correct project.
+
image:images/projects/ocp-console-project-selected.png[Selected project]
