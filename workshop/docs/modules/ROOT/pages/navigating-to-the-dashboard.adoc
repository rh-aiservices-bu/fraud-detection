...
+
image:images/projects/ocp-console-ds-tile.png[Data Science dashboard link]
...
+
image:images/projects/login-with-openshift.png[OpenShift login, 300]
+
...
+
image:images/projects/dashboard-explore.png[Dashboard enabled]
+
...
+
image:images/projects/ds-console-ocp-tile.png[OCP console link]
